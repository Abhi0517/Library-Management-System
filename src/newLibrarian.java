...
public class newLibrarian extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 250, 230, 30));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 106, 34));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 106, 34));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            Date dateOfJoining = (Date)jDateChooser1.getDate();
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            String doJ = dateFormat.format(dateOfJoining);
            if(!librarianID.equals("") && !Name.equals("") && !phoneNumber.equals(""))
            {Connection connect = ConnectionProvider.getConnect();
            Statement st = connect.createStatement();
            st.executeUpdate("Insert into Librarian Values('"+librarianID+"','"+Name+"','"+phoneNumber+"','"+doJ+"')");
